...
const CONFIG = {
    ...
    UPGRADES: {
        ...
        ROOM_EXPAND: {
            ...
            // 装飾レベル: 1=松明, 2=旗バナー, 3=クリスタル, 4=魔法陣（すべてすり抜け可能）
        },
    },
...
const TANK_PARTS = {
    ...
    // === スキン（戦車の見た目を丸ごと変える）===
    skins: [
        { id: 'skin_default',  name: '🏰 ロイヤルキャッスル', desc: '城型の王道デザイン',  isDefault: true, attackSpeedMult: 1.00, attackSpeedLabel: '標準', hpMult: 1.00 },
        { id: 'skin_ninja',    name: '🥷 シノビ',             desc: '忍者・侍スタイル',         attackSpeedMult: 1.00, attackSpeedLabel: '標準', hpMult: 1.00 },
        { id: 'skin_crab',     name: '🦀 カニカマ',           desc: 'ハサミが飛び出すカニスタイル', attackSpeedMult: 1.00, attackSpeedLabel: '標準', hpMult: 1.00 },
    ...
    playerSkins: [
        { id: 'pslime_default', name: 'なし',          desc: '素のスライム', isDefault: true,
          hat: null,
          bodyColor: '#F5F5F5', bodyDark: '#BDBDBD' },
        { id: 'pslime_wizard',  name: '🧙 まほうつかい', desc: 'とんがり魔法帽子',
          hat: 'wizard',  hatColor: '#5C2D91', hatBrim: '#7B3FBE', hatStar: '#FFD700',
          bodyColor: '#CE93D8', bodyDark: '#7B1FA2' },
        { id: 'pslime_knight',  name: '⚔️ ナイト',      desc: 'ピカピカの兜',
          hat: 'knight',  hatColor: '#607D8B', hatBrim: '#90A4AE', hatAccent: '#FFD700',
          bodyColor: '#90A4AE', bodyDark: '#455A64' },
        { id: 'pslime_party',   name: '🎉 パーティー',   desc: 'カラフルなパーティーハット',
          hat: 'party',   hatColor: '#FF6D00', hatStripe: '#FF1744',
          bodyColor: '#FFB74D', bodyDark: '#E65100' },
        { id: 'pslime_chef',    name: '👨‍🍳 コック',       desc: 'まっしろコック帽',
          hat: 'chef',    hatColor: '#FAFAFA', hatBrim: '#E0E0E0',
          bodyColor: '#FFF9C4', bodyDark: '#F9A825' },
        { id: 'pslime_crown',   name: '👑 おうさま',     desc: 'きらきら王冠',
          hat: 'crown',   hatColor: '#FFD700', hatGem: '#F44336', hatAccent: '#FFA000',
          bodyColor: '#FFD700', bodyDark: '#F57F17' },
        { id: 'pslime_santa',   name: '🎅 サンタ',       desc: 'サンタさんの帽子',
          hat: 'santa',   hatColor: '#C62828', hatBrim: '#FAFAFA', hatPom: '#FAFAFA',
          bodyColor: '#EF9A9A', bodyDark: '#C62828' },
        { id: 'pslime_halo',    name: '😇 エンジェル',   desc: '光る天使の輪',
          hat: 'halo',    hatColor: '#FFD700',
          bodyColor: '#E3F2FD', bodyDark: '#7986CB' },
    ],
    effects: [
