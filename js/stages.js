...
const STAGES_CHAPTER5 = [
    ...
    // ============================================================
    {
        ...
        entranceLines: [
            '……来たか。',
            'この場所に辿り着いた者は——お前が、初めてだ。',
            '……長かった。本当に、長かったな。スラりん。',
            'さあ——終わりにしよう。わしも、お前も、全力で。',
        ],
        // ──────────────────────────────────────────────────────────
        // 戦闘前ダイアログ（入場演出後に表示）
        // ──────────────────────────────────────────────────────────
        dialogue: [
            { speaker: 'スラりん', text: 'スライム王……！ずっと探してた。会いたかった。' },
            { speaker: 'スライム王', text: '……そうか。' },
            { speaker: 'スラッチ', text: 'なんで、こんな場所に一人で……？ みんな、ずっと待ってたのに。' },
            { speaker: 'スライム王', text: '……待たせて、すまなかった。だが——わしにはここに残る理由があった。このコアを、誰かに渡してはならなかった。' },
            { speaker: 'ニヒルム', text: '……（静かに）あなたは、ずっと一人で守り続けていたのか。世界の始まりで——たった一人で。' },
            { speaker: 'スライム王', text: '……お前が来るとは思わなかった、ニヒルム。闇の王が、誰かのために動く日が来るとは。……世界も、変わるものだな。' },
            { speaker: 'スラりん', text: '一緒に帰ろう。もう一人じゃなくていい。ぼくたちが——ここに来た。' },
            { speaker: 'スライム王', text: '……スラりん。お前は、わしが思っていたより——ずっと強くなった。だからこそ、このコアを渡せる。だからこそ——本気でぶつかれる。' },
            { speaker: 'スライム王', text: '……来い。これが、わしにできる最後の仕事だ。' },
        ],
        // ──────────────────────────────────────────────────────────
        // 敗北後ダイアログ（コア奪取変身イベント後、エンディング前に表示）
        // ──────────────────────────────────────────────────────────
        defeatDialogue: [
            { speaker: 'スライム王', text: '……負けた。本当に、負けたか。' },
            { speaker: 'スライム王', text: '……いい戦いだった。わしが長い時間、夢見ていた戦いだった。' },
            { speaker: 'スラりん', text: 'スライム王……！ありがとう。全部、受け止めた。' },
            { speaker: 'スライム王', text: 'このコアは——お前に渡す。わしより、ずっとふさわしい。……スラりん、お前の旅は本物だった。' },
            { speaker: 'ニヒルム', text: '……あなたが守り続けたものを、今度はわたしたちが守る。もう、一人じゃない。' },
            { speaker: 'スライム王', text: '……フン。なんだ、みんな揃って——泣きそうな顔をするな。みっともない。' },
            { speaker: 'スラッチ', text: 'だって……！ だって、ずっと心配してたんですよ……！ご飯、冷めちゃいました……。' },
            { speaker: 'スライム王', text: '……バカ者。そんな話を今するか。……帰るぞ。王が先頭を歩いてやる。光栄に思え。' },
            { speaker: 'スラりん', text: '……うん。帰ろう、スライム王。みんなで——村に。' },
        ],
    },
];
