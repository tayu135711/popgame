...
const STAGES_CHAPTER3 = [
    {
        ...
        tankType: 'SCOUT',
        enemySkin: 'skin_ghost',
        skyColors: ['#d8f1ff', '#c7e6ff', '#eef8ff', '#b9ddff'],
        reward: ['mega_herb', 'sun_stone', 'master_emblem'],
        invasion: { switches: 5, defenders: 5, lasers: 2 },
        dialogue: [
            { speaker: 'スラッチ', text: 'うわあ……空の上まで来ちゃった。ここ、本当に天国みたいだね。' },
            { speaker: 'スラりん', text: 'きれいだけど、気配はあるよ。油断しないでいこう。' },
            { speaker: '雲門の番人', text: '生きた者よ。ここは試される場所。覚悟があるなら、光の砲火を越えてみよ。' },
    ...
    },
    {
        ...
        tankType: 'SCOUT',
        enemySkin: 'skin_mecha',
        skyColors: ['#fff6d8', '#f8f0ff', '#dff7ff', '#fffef8'],
        reward: ['thunder', 'sun_stone', 'ultimate_parts'],
        invasion: { switches: 5, defenders: 5, lasers: 2 },
        dialogue: [
            { speaker: 'スラりん', text: '床が虹色に光ってる……歩いてるだけで落ち着かないね。' },
            { speaker: 'スラッチ', text: 'でもちょっと楽しいかも。ほら、あっちからピカピカの戦車が来るよ。' },
            { speaker: '聖騎士', text: 'この回廊を進むなら、速さと信念のどちらも示しなさい。' },
            { speaker: 'スラッチ', text: 'じゃあ両方でいこう。置いていかれないでね、スライムん。' },
        ],
    },
    {
        id: 'c3_stage3',
        ...
        tankType: 'DEFENSE',
        enemySkin: 'skin_crab',
        skyColors: ['#f7fbff', '#e7eef9', '#dfe8f6', '#fdfefe'],
        reward: ['iron_shield', 'master_emblem', 'sun_stone'],
        invasion: { switches: 6, defenders: 5, lasers: 2 },
        dialogue: [
            { speaker: 'スラッチ', text: '鐘の音が近いね。なんだか胸の奥まで見られてる気がする。' },
            { speaker: '守護像', text: '急ぐ心は曇りを生む。ここでは、一撃よりも揺るがぬ意志が問われる。' },
            { speaker: 'スラりん', text: 'ぼくらだって、ただ突っ走ってきたわけじゃないよ。' },
            { speaker: 'スラッチ', text: 'うん。ここまで来たぶんだけ、ちゃんと強くなってる。' },
        ],
    },
    {
        id: 'c3_stage4',
        ...
        tankType: 'MAGICAL',
        enemySkin: 'skin_maou',
        skyColors: ['#eef0ff', '#d9ddff', '#c4cbff', '#f6f7ff'],
        reward: ['leaf_storm', 'ultimate_parts', 'legendary_core'],
        invasion: { switches: 6, defenders: 6, lasers: 3 },
        dialogue: [
            { speaker: '星詠みの司祭', text: '星の巡りは語っている。あなたたちはまだ、終点に届いていないと。' },
            { speaker: 'スラりん', text: 'だったら、その終点までの道をここで開くよ。' },
            { speaker: 'スラッチ', text: '天国でも占いは当たるのかな。試してみようよ。' },
            { speaker: '星詠みの司祭', text: 'よろしい。では、星々の加護を受けた戦車で応えましょう。' },
        ],
    },
    {
        id: 'c3_stage5',
        ...
        tankType: 'BOSS',
        enemySkin: 'skin_ghost',
        skyColors: ['#cde8ff', '#b6ddff', '#f7fcff', '#b3d6f5'],
        ...
        dialogue: [
            { speaker: 'スラりん', text: '風が強い……でも、ここを越えれば一番上だ。' },
            { speaker: '大天使', text: 'ここまで登った勇気は認めよう。だが、頂へ至る者は希望そのものを示さねばならない。' },
            { speaker: 'スラッチ', text: '希望なら、わたしたちずっと運んできたよ。ねえ、最後まで一緒に行こう。' },
            { speaker: 'スラりん', text: 'もちろん。見せよう、ぼくらの戦い方を。' },
        ],
    },
    {
        id: 'c3_boss',
        ...
        dialogue: [
            { speaker: 'セラフィム', text: '旅の終わりではない。ここは、願いの重さを量る門。' },
            { speaker: 'スラりん', text: '重さなら十分あるよ。守りたいものも、連れて帰りたい気持ちも。' },
            { speaker: 'スラッチ', text: 'だから止まれない。たとえ相手が天国の番人でもね。' },
            { speaker: 'セラフィム', text: 'ならば受けなさい。この光が、あなたたちの真意を暴くでしょう。' },
        ],
        defeatDialogue: [
            { speaker: 'セラフィム', text: '見事です。力ではなく、結びつきでここまで届いたのですね。' },
            { speaker: 'スラりん', text: 'ぼくらだけじゃない。出会ったみんなが、ここまで押し上げてくれたんだ。' },
            { speaker: 'セラフィム', text: 'その答えなら、門は開かれます。次の空へ進みなさい。' },
        ],
    },
];
