...
const STAGES = [
    ...
    // ============================================================
    {
        ...
        dialogue: [
            { speaker: 'スラッチ', text: 'スラりん、弾を拾って大砲に入れれば攻撃できますよ！' },
            { speaker: 'オレンジ', text: 'へへっ！その「コア」は俺のものだ！ 王様になんか渡さねえ！' },
            { speaker: 'スラッチ', text: '村の平和のため、コアは私たちが取り返します！' },
        ],
    },
    ...
    // ============================================================
    {
        ...
        invasion: { switches: 2, defenders: 2, lasers: 0 },
        dialogue: [
            { speaker: 'スラお',   text: '俺のコアを奪って、王様に届けるつもりだろう！' },
            { speaker: 'スラりん', text: '王様が「世界を救うために必要」だって言ったんだ！ 返して！' },
            { speaker: 'スラお',   text: 'あんな王様に渡せば、どうなるか分からねえぞ！' },
        ],
    },
    ...
    // ============================================================
    {
        ...
        dialogue: [
            { speaker: 'スフィンクス', text: '砂漠の平和を乱す者め……王に言われてコアを取りに来たな！' },
            { speaker: 'スラッチ', text: '王様は私たちに世界を救えって言っただけですよ！' },
            { speaker: 'スフィンクス', text: 'ふん、人間の言葉を信じると痛い目を見るぞ……通さん！' },
        ],
    },
    ...
    // ============================================================
    {
        ...
        dialogue: [
            { speaker: 'ダークマター', text: '排除する……このコアは王には渡さん……！' },
            { speaker: 'スラッチ',    text: 'この敵もコアを……？ ドロドロ団の被害者でしょうか？' },
            { speaker: 'スラりん',    text: 'わからないけど、放っておけない！ 倒すぞ！' },
            { speaker: 'ダークマター', text: 'ギギ……すべては無に帰す……！' },
        ],
    },
    ...
    // ============================================================
    {
        ...
        dialogue: [
            { speaker: 'ドロスケ', text: 'ドロドロ王様のために、お前たちをここで止める！' },
            { speaker: 'スラッチ', text: '私たちは世界を救うんです！ どいてください！' },
            { speaker: 'ドロスケ', text: '世界を救う？ 本当にそう思っているなら、おめでたい奴らだ！' },
        ],
    },
...
const STAGES_CHAPTER4 = [
    ...
    // ============================================================
    {
        ...
        invasion: { switches: 7, defenders: 6, lasers: 4 },
        dialogue: [
            { speaker: 'ミラージュ', text: 'お前たちが集めたコアは王様のものとなる……！' },
            { speaker: 'スラりん', text: '王様は世界を救うために頑張ってるんだぞ！' },
            { speaker: 'スラッチ', text: 'そうだ！嘘をつくな！ 行きますよ！' },
        ],
        defeatDialogue: [
...
const STAGES_CHAPTER5 = [
    ...
    // ============================================================
    {
        ...
        enemyColor: '#1a1400',
        tankType: 'TRUE_BOSS',
        enemySkin: 'skin_lumen', // ★変更: 王の城の親衛隊
        ...
        dialogue: [
            { speaker: 'スラりん', text: 'ここに王様が……！ 王様、なぜみんなを操ったんだ！' },
            { speaker: '親衛隊', text: '王様に会う資格があるのは、すべてのコアを持ってきた者だけ。' },
            { speaker: 'スラッチ', text: '私たちは利用されただけだったんですね……！' },
            { speaker: '親衛隊', text: 'さあ、コアを差し出せ！ 王様のために！' },
        ],
        defeatDialogue: [
            { speaker: '親衛隊', text: 'さすがだ……しかし、お前たちの力すら王様のものになる……。' },
        ],
    },
    ...
    // ============================================================
    {
        ...
        partReward: [{ id: 'skin_maou', category: 'skins', name: '👑 真・スライム王スキン', icon: '👑' }],
        allies: [
            { name: 'スラッチ', color: '#4CAF50', darkColor: '#2E7D32' },
        ],
        dialogue: [
            { speaker: '王様',   text: 'よくぞすべてのコアを集めてくれた。感謝するぞ、スラりんよ！' },
            { speaker: 'スラりん', text: '王様、みんなを操って傷つけるなんて、絶対に許さない！' },
            { speaker: '王様',   text: 'これこそが世界を一度リセットし、新たな最強の国を創るための計画！' },
            { speaker: 'スラッチ', text: 'そんなの勝手すぎます！ 私たちが止めてみせます！' },
            { speaker: '真・スライム王', text: '愚かな奴らだ！ 私が真の力を振るってやろう！' },
        ],
        defeatDialogue: [
            { speaker: '真・スライム王', text: 'まさか……私が集めさせたコアの力で、私自身が敗れるとは……。' },
            { speaker: 'スラりん', text: '勝手な力じゃ、みんなの心には勝てないんだ！' },
            { speaker: '真・スライム王', text: '……すまなかった。もう一度、やり直させてくれ……。' },
            { speaker: 'スラッチ', text: '王様……本当に反省しているなら、これからはみんなのために力を使ってください。' },
            { speaker: '王様',   text: 'ああ……誓おう。私の持てるすべての力で……。' },
            { speaker: 'スラりん', text: 'さあ、みんなで帰ろう。本当の平和が来たんだ！' },
        ],
    },
];
